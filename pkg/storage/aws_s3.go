...
func (s *awss3) IsExist(ctx context.Context, bucket, key string) (bool, error) {
...
func (s *awss3) GetUrl(ctx context.Context, bucket, key string, expirationTime time.Duration) (string, error) {
