...
func (s *fileSystem) GetUrl(ctx context.Context, parent, name string, expirationTime time.Duration) (string, error) {
	return "", nil
}

func (s *fileSystem) IsExist(ctx context.Context, _, _ string) (bool, error) {
	return false, nil
}
